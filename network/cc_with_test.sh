...
# setVote
echo '□□□□□□□□□□□□□□□□□□□□□□□□□□□□□□□□□□ Vote 생성 테스트 □□□□□□□□□□□□□□□□□□□□□□□□□□□□□□□□□□'
docker exec cli peer chaincode invoke -n sacc -C mychannel -c '{"Args":["setVote", "2d7b42d089129b234caa94c728406cc548dd5593c8a6fc55ee86a3e62f5b819c", "0", "테스트", "2019-11-10 00:00:00", "2019-11-11 00:00:00", "박보검", "박보영"]}'
sleep 2
docker exec cli peer chaincode invoke -n sacc -C mychannel -c '{"Args":["setVote", "724f0e7da790374cec1b52c82db372b340949be200820100e584eff369dbda9f", "1", "테스트", "2019-11-13 00:00:00", "2019-11-14 00:00:00", "우마", "헌터퐝"]}'
sleep 2
